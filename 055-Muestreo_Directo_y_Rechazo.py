...
muestra_directo = muestreo.forward_sample(size=1000)

print("Muestreo directo:")
print(muestra_directo)

# Realizar muestreo por rechazo
evidencia = [('A', 0), ('B', 1)]  # Se proporcionan como pares (variable, estado)
muestra_rechazo = muestreo.rejection_sample(evidence=evidencia, size=1000)
